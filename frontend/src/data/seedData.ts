...
export const seedApplicationState: ApplicationState = {
  departments: [
  ...
  allocations: [
    { id: 'al-1', assetId: 'a-2', employeeId: 'e-5', departmentId: 'd-1', allocatedDate: '2026-05-10', expectedReturnDate: '2026-08-10', returnedDate: '', conditionCheckin: '', notes: 'Assigned for engineering sprint work.', status: 'active' },
    { id: 'al-2', assetId: 'a-3', employeeId: 'e-3', departmentId: 'd-2', allocatedDate: '2026-06-01', expectedReturnDate: '2026-07-10', returnedDate: '', conditionCheckin: '', notes: 'Assigned for trade show deployment.', status: 'overdue' },
    { id: 'al-3', assetId: 'a-9', employeeId: 'e-6', departmentId: 'd-3', allocatedDate: '2026-06-15', expectedReturnDate: '2026-12-15', returnedDate: '', conditionCheckin: '', notes: 'Assigned for communications management.', status: 'active' }
  ],
  transfers: [
    { id: 'tr-1', assetId: 'a-3', requesterEmployeeId: 'e-5', targetDepartmentId: 'd-1', currentHolderEmployeeId: 'e-3', requestedDate: '2026-07-11', status: 'pending' }
  ],
  bookings: [
    { id: 'b-1', resourceId: 'a-5', employeeId: 'e-4', bookDate: '2026-07-13', startTime: '09:00', durationHours: '2', status: 'upcoming' },
    { id: 'b-2', resourceId: 'a-6', employeeId: 'e-5', bookDate: '2026-07-12', startTime: '14:00', durationHours: '1.5', status: 'upcoming' },
    { id: 'b-3', resourceId: 'a-12', employeeId: 'e-2', bookDate: '2026-07-12', startTime: '10:00', durationHours: '3', status: 'ongoing' }
  ],
  maintenance: [
    { id: 'm-1', assetId: 'a-7', priority: 'high', issueDescription: 'Drive Slot 4 reported read failures. Overheating alerts triggered on rack sensor.', raisedEmployeeId: 'e-2', raisedDate: '2026-07-11', status: 'progress', technicianName: 'Sarah Connor (IT Manager)', resolutionDeadline: '2026-07-14', resolvedDate: '' },
    { id: 'm-2', assetId: 'a-8', priority: 'medium', issueDescription: 'Laptop screen dimming intermittently. Seems like hardware backlighting driver issue.', raisedEmployeeId: 'e-7', raisedDate: '2026-07-12', status: 'pending', technicianName: '', resolutionDeadline: '', resolvedDate: '' }
  ],
  audits: [
    { id: 'au-1', title: 'Q2 Marketing Devices Audit', scopeDeptId: 'd-2', assignedAuditorId: 'e-2', startDate: '2026-06-01', endDate: '2026-06-10', status: 'closed', progressPercent: 100, verifiedAssetIds: ['a-3', 'a-14'], missingAssetIds: [], damagedAssetIds: [], discrepancyText: 'All marketing assets successfully verified in excellent condition.' },
    { id: 'au-2', title: 'Q3 Product Engineering Hardware Audit', scopeDeptId: 'd-1', assignedAuditorId: 'e-1', startDate: '2026-07-01', endDate: '2026-07-20', status: 'active', progressPercent: 20, verifiedAssetIds: ['a-2'], missingAssetIds: [], damagedAssetIds: [], discrepancyText: 'Cycle started. Pending checks for remaining 4 assets.' }
  ],
  notifications: [
  ...
  currentUser: null,
  activeRole: 'admin',
  activeCalendarMonth: now.getMonth(),
...
export function createSeedApplicationState(): ApplicationState {
  return structuredClone(seedApplicationState);
}
